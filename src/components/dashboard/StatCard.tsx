...
const variantStyles = {
  ...
  destructive:
    "bg-gradient-to-br from-destructive/5 to-card border-destructive/10",
};

const iconStyles = {
  default: "bg-muted text-muted-foreground",
  primary:
    "bg-gradient-to-br from-primary to-orange-400 text-white shadow-primary",
  ...
  destructive:
    "bg-gradient-to-br from-destructive to-red-400 text-white shadow-lg",
};
...
export function StatCard({
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-2xl border p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group min-h-[140px]",
